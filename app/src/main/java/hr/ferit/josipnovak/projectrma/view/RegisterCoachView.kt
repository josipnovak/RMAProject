...
@Composable
fun RegisterCoachView(modifier: Modifier = Modifier, navController: NavController, authViewModel: AuthViewModel) {
    ...
    Box(
        ...
        Column(
            ...
            Button(
                onClick = {
                    authViewModel.register(name, email, password, password1, teamName, "coach", null, null) {
